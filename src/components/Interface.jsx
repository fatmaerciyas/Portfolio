...
const Section = (props) => {
  ...
  ${mobileTop ? " md:justify-center justify-start" : " justify-center"}
  `}
      initial={{
        opacity: 0,
        y: 50,
...
const AboutSection = (props) => {
  ...
  return (
    <Section mobileTop>
      ...
      <a
        href="https://github.com/fatmaerciyas/Portfolio/blob/main/static/cv/Fatma_ErciyasCv.pdf"
        target="_blank"
  ...
  return (
    <Section>
      <motion.div className="w-full" whileInView={"visible"}>
        <h2 className="text-3xl md:text-3xl md:text-5xl font-bold text-white">
          Skills
        </h2>
...
const ContactSection = () => {
  const [state, handleSubmit] = useForm("xldrkrrv");
